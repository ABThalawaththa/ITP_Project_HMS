...
<!DOCTYPE html>
<%@page import="prm.model.Employee"%>
...
<p><a href="<%=request.getContextPath()%>/PayrollManagement/views/view_older_payslip.jsp" style="text-decoration:none;"><h2>Older Payrolls</h2></a></p><br>
    ...
    <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form action="<%=request.getContextPath()%>/PayrollManagement/views/past_payslips.jsp?id=<%=var%>" method="POST">
