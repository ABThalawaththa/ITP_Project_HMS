...
<!DOCTYPE html>
<%@page import="prm.model.Doctor"%>
<%@page import="prm.model.Nurse"%>
<%@page import="prm.model.Staff"%>
...
<!-- Required meta tags-->
	...
	<!-- Icons font CSS-->
    <link href="<%=request.getContextPath()%>/PayrollManagement/assets/vendor/mdi-font/css/material-design-iconic-font.min.css" rel="stylesheet" media="all">
    <link href="<%=request.getContextPath()%>/PayrollManagement/assets/vendor/font-awesome-4.7/css/font-awesome.min.css" rel="stylesheet" media="all">
    <!-- Font special for pages-->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800,800i" rel="stylesheet">

    <!-- Vendor CSS-->
    <link href="<%=request.getContextPath()%>/PayrollManagement/assets/vendor/select2/select2.min.css" rel="stylesheet" media="all">
    <link href="<%=request.getContextPath()%>/PayrollManagement/assets/vendor/datepicker/daterangepicker.css" rel="stylesheet" media="all">

    <!-- Main CSS-->
    <link href="<%=request.getContextPath()%>/PayrollManagement/assets/css/main.css" rel="stylesheet" media="all">
...
<p><a href="<%=request.getContextPath()%>/PayrollManagement/views/create_payslip.jsp" style="text-decoration:none;"><h2>Create Payrolls</h2></a></p><br>
    ...
    <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
       ...
       if(stat.equals("doctors")){
    	   href = "non_created_doctors.jsp";%>
                    <form action="<%=request.getContextPath()%>/PayrollManagement/views/<%=href%>" method="POST">
...
<!-- Footer End -->
    ...
    <!-- Jquery JS-->
    <script src="<%=request.getContextPath()%>/PayrollManagement/assets/vendor/jquery/jquery.min.js"></script>
    <!-- Vendor JS-->
    <script src="<%=request.getContextPath()%>/PayrollManagement/assets/vendor/select2/select2.min.js"></script>
    <script src="<%=request.getContextPath()%>/PayrollManagement/assets/vendor/datepicker/moment.min.js"></script>
    <script src="<%=request.getContextPath()%>/PayrollManagement/assets/vendor/datepicker/daterangepicker.js"></script>

    <!-- Main JS-->
    <script src="<%=request.getContextPath()%>/PayrollManagement/assets/js/global.js"></script>	
</body>
</html>