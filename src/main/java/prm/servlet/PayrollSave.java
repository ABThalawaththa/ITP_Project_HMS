...
public class PayrollSave extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/PayrollManagement/views/non_created_doctors.jsp").forward(request, response);
			...
			request.getRequestDispatcher("/PayrollManagement/views/non_created_nurses.jsp").forward(request, response);
			...
			request.getRequestDispatcher("/PayrollManagement/views/non_created_staff.jsp").forward(request, response);
		}
